...
export default function EditProductPage() {
  ...
  const {
    ...
    handleRemoveColor,
    handleRemoveImage,
    handleSubmit, // This handles Update if initialData.id is present
    CATEGORIES,
    SIZE_OPTIONS,
    MATERIALS,
  ...
  // Map simple remove to match UI invocation
  const handleRemoveColorComplete = (index) => handleRemoveColor(index);
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {uploadedImagesCount < 3 && (
          <Alert className="mb-6 bg-yellow-50 border-yellow-200">
            <AlertDescription>
              ⚠️ At least 3 images are recommended for a product listing.
            </AlertDescription>
          </Alert>
        )}
              ...
              <div className="space-y-6">
                ...
                {formData.colors.length > 0 && (
                  <div className="space-y-4">
                    <div className="flex justify-between items-center">
                      <Label>
                        Existing Colors ({formData.colors.length})
                      </Label>
                    </div>
                      ...
                      {formData.colors.map((color, index) => (
                        ...
                        >
                          <div className="aspect-square mb-2 rounded overflow-hidden">
                            <img
                              src={color.preview || color.image_url}
                              alt={color.name}
                              className="w-full h-full object-cover"
                            />
                          </div>
                          ...
                          <button
                            type="button"
                            onClick={() => handleRemoveColorComplete(index)}
