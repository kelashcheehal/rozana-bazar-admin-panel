    ...
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <Link
          ...
          className="bg-[#ffffff] text-black text-sm px-4 py-2 rounded flex items-center gap-2"
        >
      ...
      {/* Stats */}
      <div className="flex items-center gap-4 p-4 overflow-x-auto min-w-full flex-wrap md:flex-nowrap">
